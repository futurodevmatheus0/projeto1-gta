...
Objetivo 1 - quando o usuário clicar no botão de seleção de plataformas deve abrir uma caixa com os botões de seleção de plataforma
     ...
     Passo 3 - pegar o clique do usuario do js

     Passo 4 - quando o usuário clicar, adicionar a classe ativo na listagem plataformas dentro do botão pra que o conteúdo dele apareça
